...
![Queries](https://img.shields.io/badge/Total%20Queries-186-purple?style=flat-square)
...
| # | Title | Queries | Key Techniques | Link |
|---|---|---|---|---|
| 00 | KQL 101 — Intro to Kusto | 12 | Core operators, `let`, `in()` | [→ Open](investigations/security-analyst-II/00-kql-101-intro.md) |
| 01 | Encryptodera — Ransomware & Insider Threat | 38 | T1486, T1003.001, T1484.001, T1567 | [→ Open](investigations/security-analyst-II/01-encryptodera-ransomware-insider-threat.md) |
| 02 | ValdoriaVotes — Election Interference | 20 | T1566.002, T1056.003, T1583, T1530 | [→ Open](investigations/security-analyst-II/02-valdoriavotes-election-interference.md) |
| 03 | Whiskers & Wonders — Network & C2 | 22 | T1071.001, T1071.004, T1572 | [→ Open](investigations/security-analyst-II/03-whiskers-and-wonders-network-c2.md) |
| 04 | Solvi Systems — Supply Chain & ICS | 27 | T1190, T1583, T1021.002, T1567 | [→ Open](investigations/security-analyst-II/04-solvi-systems-supply-chain-ics.md) |
